      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg text-gray-700 max-w-none space-y-6">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><strong>Farm Details:</strong> Total land acreage, farming practices, estimated credits.</li>
            <li><strong>Payment Information:</strong> We use secure providers like Razorpay. We do not store your complete payment details on our servers.</li>
          </ul>

          <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">How We Use Your Information</h2>
          <p>We use the collected information in various ways, including to:</p>
          <ul className="list-disc pl-6 space-y-2">
            <li>Provide, operate, and maintain our website and marketplace.</li>
